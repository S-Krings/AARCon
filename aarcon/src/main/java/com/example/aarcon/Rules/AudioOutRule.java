...
public class AudioOutRule extends Rule{
    ...
    public AudioOutRule(Activity activity, String speech) {
        this.activity = activity;
        this.speech = speech;
        instanciateTextToSpeech();
    }

    public AudioOutRule(Activity activity, String speech, String utteranceID) {
        this.activity = activity;
        this.speech = speech;
    ...
    public AudioOutRule(Control control, Activity activity, String speech) {
        super(control);
        this.activity = activity;
        this.speech = speech;
    ...
    public AudioOutRule(Control control, Activity activity, String speech, String utteranceID) {
        super(control);
        this.activity = activity;
        this.speech = speech;
        this.utteranceID = utteranceID;
