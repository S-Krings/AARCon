...
public class FaceUserRule extends Rule {
    ...
    public FaceUserRule(ArFragment arFragment, TransformableNode transformableNode) {
        this.arFragment = arFragment;
        this.transformableNode = transformableNode;
    }

    public FaceUserRule(Control control, ArFragment arFragment, TransformableNode transformableNode) {
        super(control);
        this.arFragment = arFragment;
        this.transformableNode = transformableNode;
    }
