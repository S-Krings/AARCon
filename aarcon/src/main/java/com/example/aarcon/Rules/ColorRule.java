...
public class ColorRule extends Rule {
    ...
    public ColorRule(Activity activity, TransformableNode transformableNode) {
        this.activity = activity;
        this.transformableNode = transformableNode;
    }

    public ColorRule(Activity activity, TransformableNode transformableNode, Color color) {
        this.activity = activity;
        this.transformableNode = transformableNode;
        this.color = color;
    }

    public ColorRule(Control control, Activity activity, TransformableNode transformableNode) {
        super(control);
        this.activity = activity;
        this.transformableNode = transformableNode;
    }

    public ColorRule(Control control, Activity activity, TransformableNode transformableNode, Color color) {
        super(control);
        this.activity = activity;
        this.transformableNode = transformableNode;
        this.color = color;
