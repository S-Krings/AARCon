...
public class TransparencyRule extends Rule {
    ...
    public TransparencyRule(Activity activity, TransformableNode transformableNode) {
        this.activity = activity;
        this.transformableNode = transformableNode;
    }

    public TransparencyRule(Activity activity, TransformableNode transformableNode, Color transparentColor) {
        this.activity = activity;
        this.transformableNode = transformableNode;
        this.transparentColor = transparentColor;
    }

    public TransparencyRule(Control control, Activity activity, TransformableNode transformableNode) {
        super(control);
        this.transformableNode = transformableNode;
        this.activity = activity;
    }

    public TransparencyRule(Control control, Activity activity, TransformableNode transformableNode, Color transparentColor) {
        super(control);
        this.activity = activity;
        this.transformableNode = transformableNode;
        this.transparentColor = transparentColor;
