...
public class VoiceRecognitionRule extends Rule {
    private Activity activity;
    private Button button;

    public VoiceRecognitionRule(Activity activity, Button button) {
        this.activity = activity;
        this.button = button;
    }

    public VoiceRecognitionRule(Control control, Activity activity, Button button) {
        super(control);
        this.activity = activity;
        this.button = button;
    }
