...
/**
 * Action subclass for rotating a TransformableNode to always face the user.
 */
public class ChangePoseToUserAction extends Action {
    ...
    public ChangePoseToUserAction(ArFragment arFragment, TransformableNode transformableNode) {
        this.arFragment = arFragment;
        this.transformableNode = transformableNode;
    }

    public ChangePoseToUserAction(Control control, ArFragment arFragment, TransformableNode transformableNode) {
        super(control);
        this.arFragment = arFragment;
        this.transformableNode = transformableNode;
    }
