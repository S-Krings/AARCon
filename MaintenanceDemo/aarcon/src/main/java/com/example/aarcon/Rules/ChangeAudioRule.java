...
public class ChangeAudioRule extends Rule{
    ...
    public ChangeAudioRule(Activity activity, String speech) {
        this.activity = activity;
        this.speech = speech;
        instanciateTextToSpeech();
    }

    public ChangeAudioRule(Activity activity, String speech, String utteranceID) {
        this.activity = activity;
        this.speech = speech;
    ...
    public ChangeAudioRule(Control control, Activity activity, String speech) {
        super(control);
        this.activity = activity;
        this.speech = speech;
    ...
    public ChangeAudioRule(Control control, Activity activity, String speech, String utteranceID) {
        super(control);
        this.activity = activity;
        this.speech = speech;
        this.utteranceID = utteranceID;
