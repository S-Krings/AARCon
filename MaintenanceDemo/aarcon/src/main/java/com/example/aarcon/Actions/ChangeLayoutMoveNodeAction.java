...
/**
 * Action subclass for adding an arrow to any ViewRenderable, which, when clicked, teleports it one meter to the right.
 */
public class ChangeLayoutMoveNodeAction extends Action {
    ...
    public ChangeLayoutMoveNodeAction(ArFragment arFragment, ViewGroup viewGroup, TransformableNode node) {
    ...
    public ChangeLayoutMoveNodeAction(Control control, ArFragment arFragment, ViewGroup viewGroup, TransformableNode node) {
        super(control);
        this.arFragment = arFragment;
        this.viewGroup = viewGroup;
        this.node = node;
