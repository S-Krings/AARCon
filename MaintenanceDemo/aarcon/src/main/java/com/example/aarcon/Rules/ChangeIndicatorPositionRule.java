...
public class ChangeIndicatorPositionRule extends Rule {
    ...
    public ChangeIndicatorPositionRule(ArFragment arFragment, ImageView indicatorView, TransformableNode transformableNode) {
    ...
    public ChangeIndicatorPositionRule(Control control, ArFragment arFragment, ImageView indicatorView, TransformableNode transformableNode) {
        super(control);
        this.arFragment = arFragment;
        this.indicatorView = indicatorView;
        this.transformableNode = transformableNode;
