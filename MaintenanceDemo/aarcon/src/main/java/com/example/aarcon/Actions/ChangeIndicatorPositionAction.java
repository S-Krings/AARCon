...
/**
 * Action subclass for rotating an ImageView so its right side always points to a TransformableNode's position on the screen.
 */
public class ChangeIndicatorPositionAction extends Action {
    ...
    public ChangeIndicatorPositionAction(ArFragment arFragment, ImageView indicatorView, TransformableNode transformableNode) {
    ...
    public ChangeIndicatorPositionAction(Control control, ArFragment arFragment, ImageView indicatorView, TransformableNode transformableNode) {
        super(control);
        this.arFragment = arFragment;
        this.indicatorView = indicatorView;
        this.transformableNode = transformableNode;
