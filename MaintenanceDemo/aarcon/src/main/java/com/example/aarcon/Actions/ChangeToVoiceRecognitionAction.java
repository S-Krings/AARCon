...
/**
 * Action subclass for activating the voice recognition by google.
 */
public class ChangeToVoiceRecognitionAction extends Action {
    private Activity activity;
    private Button button;

    public ChangeToVoiceRecognitionAction(Activity activity, Button button) {
        this.activity = activity;
        this.button = button;
    }

    public ChangeToVoiceRecognitionAction(Control control, Activity activity, Button button) {
        super(control);
        this.activity = activity;
        this.button = button;
    }
