...
/**
 * Action subclass for changng the language f the application and reloading ViewRenderables for the changes to appear.
 */
public class ChangeLanguageAction extends Action {
    ...
    public ChangeLanguageAction(Activity activity, String language) {
        this.activity = activity;
        this.language = language;
    }

    public ChangeLanguageAction(Activity activity, String language, String country) {
        this.activity = activity;
        this.language = language;
        this.country = country;
    }

    public ChangeLanguageAction(Control control, Activity activity, String language, String country) {
        super(control);
        this.activity = activity;
        this.language = language;
        this.country = country;
    ...
    public ChangeLanguageAction(Control control, Activity activity, String language) {
        super(control);
        this.activity = activity;
        this.language = language;
    }
